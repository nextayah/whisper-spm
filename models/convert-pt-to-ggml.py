...
hparams = {
    "n_mels": 80,  # Based on "num_mel_bins"
    "n_vocab": 51865,  # Based on "vocab_size"
    "n_audio_ctx": 1500,  # Based on "max_source_positions"
    "n_audio_state": 384,  # Based on "d_model"
    "n_audio_head": 6,  # Based on "encoder_attention_heads"
    "n_audio_layer": 4,  # Based on "encoder_layers"
    "n_text_ctx": 448,  # Based on "max_target_positions"
    "n_text_state": 384,  # Based on "d_model"
    "n_text_head": 6,  # Based on "decoder_attention_heads"
    "n_text_layer": 4  # Based on "decoder_layers"
}
